...
export default function NewMenuItemScreen() {
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Permission needed",
        "Allow access to your photos to add menu item images."
      );
      return;
    }
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <View style={styles.headerCenter}>
          ...
          <Text style={styles.headerSubtitle}>Create a new dish for your menu</Text>
        </View>
          ...
          >
            {saving ? (
              ...
              <>
                ...
                <Text style={styles.createBtnText}>Create menu item</Text>
              </>
            )}
          </TouchableOpacity>
        </View>
